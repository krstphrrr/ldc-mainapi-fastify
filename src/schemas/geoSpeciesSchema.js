const geoSpeciesSchema = {
    ...
    properties: {
      ...
      AH_SpeciesCover: { anyOf: [{ type: 'number' }, { type: 'array', items: { type: 'number' } }] },
      AH_SpeciesCover_n: { anyOf: [{ type: 'integer' }, { type: 'array', items: { type: 'integer' } }] },
      Hgt_Species_Avg: { anyOf: [{ type: 'number' }, { type: 'array', items: { type: 'number' } }] },
      Hgt_Species_Avg_n: { anyOf: [{ type: 'integer' }, { type: 'array', items: { type: 'integer' } }] },
