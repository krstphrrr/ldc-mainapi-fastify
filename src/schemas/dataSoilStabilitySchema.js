const dataSoilStabilitySchema = {
    ...
    properties: {
      ...
      SoilStabSubSurface: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
      Line: { anyOf: [{ type: 'string' }, { type: 'array', items: { type: 'string' } }] },
      Position: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
      Pos: { anyOf: [{ type: 'string' }, { type: 'array', items: { type: 'string' } }] },
      Veg: { anyOf: [{ type: 'string' }, { type: 'array', items: { type: 'string' } }] },
      Rating: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
      Hydro: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
