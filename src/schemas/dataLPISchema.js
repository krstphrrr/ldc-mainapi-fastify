const dataLPISchema = {
    ...
    properties: {
      ...
      chckbox: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
      ...
      Measure: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
      LineLengthAmount: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
      SpacingIntervalAmount: { anyOf: [{ type: 'number' }, { type: 'string' }, { type: 'array', items: { type: 'number' } }] },
      SpacingType: { anyOf: [{ type: 'string' }, { type: 'array', items: { type: 'string' } }] },
      ShowCheckbox: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
      CheckboxLabel: { anyOf: [{ type: 'string' }, { type: 'array', items: { type: 'string' } }] },
      PointLoc: { anyOf: [{ type: 'number' }, { type: 'string' }, { type: 'array', items: { type: 'number' } }] },
      PointNbr: { anyOf: [{ type: 'integer' }, { type: 'string' }, { type: 'array', items: { type: 'integer' } }] },
